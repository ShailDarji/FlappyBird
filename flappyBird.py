...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            ...
            # If user presses space or up key then start the game
...
def mainGame():
    ...
    playerFlapped = False   # It is true only
    ...
    while True:
        ...
        crashTest = isCollide(playerx, playery, upperPipes, lowerPipes)     # This function will return true if
        # player is crashed
...
def getRandomPipe():
    ...
    pipe = [
        {'x': pipex, 'y': -y1},     # For upper pipe we use -
...
if __name__ == '__main__':
    ...
    while True:
        welcomeScreen()  # Shows Welcomescreen to user till player hit the start game
